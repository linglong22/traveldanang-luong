...
<!-- top-header -->
	<div class="agile-main-top" >
		<div class="container-fluid">
			<div class="row main-top-w3l py-2" style="background-color: rgb(235, 152, 15)">
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<a href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>" class="text-white">
								<i class="fas fa-user mr-2"></i>Tài khoản : <?php echo $_SESSION['dangnhap_home'] ?></a>
						</li>
						<?php
					}
						?>
						<li class="text-center border-right text-white">
							<i class="fas fa-phone mr-2"><a style="color: white" href="tel:+0899866789"> 0899866789</a></i>
						</li>
						<li class="text-center border-right text-white">
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.php" class="font-weight-bold font-italic">
							<img src="images/logo.png" height="80px" width="80px" alt=" " class="img-fluid">Travel Đà Nẵng
						</a>
					</h1>
				</div>
				<!-- //logo -->
